"""
AG2 (AutoGen v2) — Policy Checker · Streamlit Frontend
"""
...
st.set_page_config(
    page_title="Policy Checker · AG2",
    page_icon="⚖️",
    layout="centered",
)

st.title("Policy Checker — AG2 (AutoGen)")
st.caption(
    "Multi-agent pipeline · Intake → Specialists (GroupChat) → Reviewer → Synthesis → Verdict"
)
